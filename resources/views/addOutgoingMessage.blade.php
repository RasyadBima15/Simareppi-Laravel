...
@section('content')
    <div class="flex flex-col justify-center items-center w-[81%]">
        ...
        <div class="block w-[70%] mt-12 ml-5 p-6 bg-transparent border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 overflow-y-auto">
            <form class="space-y-6" action="{{route('addOutgoingMessage')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="flex justify-between">
                    <h5 class="text-xl font-medium text-gray-900 dark:text-white">Tambah Surat Keluar</h5>
                ...
                <button type="submit" class="w-full text-white bg-green-600 border hover:bg-green-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Tambah Surat Keluar</button>
            </form>
        </div>
    </div>
@endsection
